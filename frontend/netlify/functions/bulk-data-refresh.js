/**
 * Bulk Data Refresh - Netlify Background Function
 *
 * Generates Scryfall-compatible bulk data from Shopify inventory
 * and stores it in Netlify Blobs. No rebuild required!
 *
 * Runs on schedule (every 30 min) or can be triggered manually.
 */
...
// Blob store for bulk data
const BLOB_STORE_NAME = 'bulk-data';
const BLOB_KEY = 'inventory';

// Set code overrides for Scryfall matching
...
// Export as background function (15 min timeout)
exports.handler = async (event, context) => {
  console.log('🔄 Bulk data refresh started');
...
// Mark as background function for 15 min timeout
exports.config = {
