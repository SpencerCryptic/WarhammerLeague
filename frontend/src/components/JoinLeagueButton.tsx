  ...
  useEffect(() => {
    const checkMembership = async () => {
      try {
        ...
        const userResponse = await fetch(`http://localhost:1337/api/users/me?populate[player]=*`, {
        ...
        const leagueResponse = await fetch(`http://localhost:1337/api/leagues/${leagueId}?populate[league_players][populate]=player`);
