    ...
    <div className="min-h-screen" style={{ backgroundColor: '#0F1117' }}>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6 mb-8 sm:mb-16">
          <div className="rounded-lg p-4 sm:p-6 text-center border transition-colors duration-300 shadow-lg" style={{ backgroundColor: '#1E2330', borderColor: 'rgba(168, 85, 247, 0.15)' }} onMouseEnter={(e) => e.currentTarget.style.borderColor = '#FF7F2A'} onMouseLeave={(e) => e.currentTarget.style.borderColor = 'rgba(168, 85, 247, 0.15)'}>
          ...
          <div className="rounded-lg p-4 sm:p-6 text-center border transition-colors duration-300 shadow-lg" style={{ backgroundColor: '#1E2330', borderColor: 'rgba(168, 85, 247, 0.15)' }} onMouseEnter={(e) => e.currentTarget.style.borderColor = '#059669'} onMouseLeave={(e) => e.currentTarget.style.borderColor = 'rgba(168, 85, 247, 0.15)'}>
          ...
          <div className="rounded-lg p-4 sm:p-6 text-center border transition-colors duration-300 shadow-lg" style={{ backgroundColor: '#1E2330', borderColor: 'rgba(168, 85, 247, 0.15)' }} onMouseEnter={(e) => e.currentTarget.style.borderColor = '#A855F7'} onMouseLeave={(e) => e.currentTarget.style.borderColor = 'rgba(168, 85, 247, 0.15)'}>
            <div className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-1 sm:mb-2" style={{ color: '#A855F7' }}>{stats.totalPlayers}</div>
            <div className="text-gray-300 text-xs sm:text-sm font-medium uppercase tracking-wide">Total Players</div>
          </div>
        </div>

        {/* Main Content Container */}
        <div className="rounded-2xl p-4 sm:p-6 lg:p-8 border shadow-2xl" style={{ backgroundColor: 'rgba(30, 35, 48, 0.5)', borderColor: 'rgba(168, 85, 247, 0.15)' }}>
              ...
              <div className="space-y-6">
                {leagues.length > 0 ? (
                  leagues.map((league: any) => (
                    <Link key={league.id} href={`/leagues/${league.documentId}`} className="block rounded-lg p-4 border-l-4 transition-colors duration-200 cursor-pointer" style={{ backgroundColor: '#2D3548', borderLeftColor: '#A855F7' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#3A4558'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#2D3548'}>
                  ...
                  <div className="rounded-lg p-6 text-center border-l-4" style={{ backgroundColor: '#2D3548', borderLeftColor: 'rgba(168, 85, 247, 0.2)' }}>
                ...
                {currentLeagues.length > 0 ? (
                  (() => {
                    ...
                    return Object.entries(grouped).map(([baseName, leagues]) => {
                      ...
                      return (
                        <div key={baseName} className="rounded-lg border-l-4" style={{ backgroundColor: '#2D3548', borderLeftColor: '#059669' }}>
                          <Link href={`/leagues/${mainLeague.documentId}`} className="block p-4 transition-colors duration-200" onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#3A4558'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = 'transparent'}>
                              ...
                              {leagues.map((league: any, idx: number) => {
                                ...
                                return (
                                  <Link
                                    ...
                                    onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#2D3548'}
                                    onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#1E2330'}
                                  >
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {topPlayers.length > 0 ? (
                  topPlayers.map((player: any, index: number) => {
                    ...
                    return (
                      <div key={player.id} className="flex items-start justify-between p-4 rounded-lg transition-all duration-200 border" style={{ backgroundColor: '#2D3548', borderColor: 'rgba(168, 85, 247, 0.2)' }} onMouseEnter={(e) => { e.currentTarget.style.backgroundColor = '#3A4558'; e.currentTarget.style.borderColor = 'rgba(168, 85, 247, 0.3)'; }} onMouseLeave={(e) => { e.currentTarget.style.backgroundColor = '#2D3548'; e.currentTarget.style.borderColor = 'rgba(168, 85, 247, 0.2)'; }}>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {upcomingEvents.length > 0 ? (
                  upcomingEvents.map((event: any, index: number) => {
                    ...
                    return (
                      <div key={index} className={`rounded-lg p-4 border-l-4 ${colorClass} transition-all duration-200`} style={{ backgroundColor: '#2D3548' }} onMouseEnter={(e) => e.currentTarget.style.backgroundColor = '#3A4558'} onMouseLeave={(e) => e.currentTarget.style.backgroundColor = '#2D3548'}>
          ...
          <div className="mb-8 sm:mb-12">
            <div className="rounded-xl p-4 sm:p-6 lg:p-8 border transition-all duration-300 shadow-xl hover:shadow-2xl" style={{ backgroundColor: '#1E2330', borderColor: 'rgba(168, 85, 247, 0.15)' }} onMouseEnter={(e) => e.currentTarget.style.borderColor = 'rgba(168, 85, 247, 0.25)'} onMouseLeave={(e) => e.currentTarget.style.borderColor = 'rgba(168, 85, 247, 0.15)'}>
