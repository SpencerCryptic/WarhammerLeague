export default ({ env }) => {
  // Use nodemailer if SMTP environment variables are set, otherwise fall back to Strapi Cloud
  const useNodemailer = env('SMTP_USER') && env('SMTP_PASS');
